...
class ServiceTest extends TestCase
{
     ...
     */
    public function testTransform($expect, $number): void
    {
        ...
        $this->assertEquals($expect, $service->toWords($number));
    }

    /**
     * @dataProvider currencyDataProvider
     */
    public function testCurrencyTransform($expect, $number): void
    {
        static $container = null;
        ...
        $service = $container->get('n2w');
        $this->assertEquals($expect, $service->toCurrency($number));
    }
